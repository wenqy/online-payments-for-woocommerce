...
//define('SDK_SIGN_CERT_PATH',rtrim(plugin_dir_path(__FILE__),'/').'/../certs/acp_test_sign.pfx');
...
// 前台通知地址 (商户自行配置通知地址)
const SDK_FRONT_NOTIFY_URL = 'http://localhost/upacp_demo_b2c/demo/api_01_gateway/FrontReceive.php';
...
define('SDK_LOG_FILE_PATH',rtrim(plugin_dir_path(__FILE__),'/'));
